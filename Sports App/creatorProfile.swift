...
//  Sports App
//
//  Created by Dayton Flores on 4/23/19.
...
class creatorProfile: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ref.child("users").child(uid!).observe(DataEventType.value, with: { (snapshot) in        // updates if database entry changes
